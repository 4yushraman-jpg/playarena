...
import (
	...
	match_events "github.com/4yushraman-jpg/playarena/internal/match_events"
...
func buildTestServer(t testing.TB, pool *pgxpool.Pool) *testServer {
	...
	r.Group(func(r chi.Router) {
		...
		matches.RegisterRoutes(r, pool, cfg, logger, authz, notifSvc)
		match_events.RegisterRoutes(r, pool, cfg, logger, authz)
	})
