...
func teamsURL(orgSlug string) string {
	return fmt.Sprintf("/api/v1/organizations/%s/teams", orgSlug)
}

func teamURL(orgSlug, teamID string) string {
	return fmt.Sprintf("/api/v1/organizations/%s/teams/%s", orgSlug, teamID)
}

func membersURL(orgSlug, teamID string) string {
	return fmt.Sprintf("/api/v1/organizations/%s/teams/%s/members", orgSlug, teamID)
}

func memberURL(orgSlug, teamID, membershipID string) string {
	return fmt.Sprintf("/api/v1/organizations/%s/teams/%s/members/%s", orgSlug, teamID, membershipID)
}
