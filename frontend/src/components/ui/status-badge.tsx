...
export type MatchStatus = "scheduled" | "live" | "completed" | "cancelled" | "abandoned" | "walkover"
...
const STATUS_CONFIG: Record<StatusType, { label: string; className: string }> = {
  ...
  walkover:            { label: "Walkover",             className: "bg-amber-50  text-amber-700  border-amber-200  dark:bg-amber-950/40 dark:text-amber-300  dark:border-amber-800" },
  // Tournament
